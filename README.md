...
There are a several different types of experiments here, and three different sources for random numbers used. The different random number generator types are captured in subfolders.

The Geiger folder represents the most recent iterations.
