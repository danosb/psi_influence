...
error = Message(text="Previous experiments, mostly done by Helmut Schmidt in the 70s and 80s, suggest that prior to being observed random numbers can be influenced by intention. Here, we aim to improve on these experiments by using quantum random numbers to drive all aspects of the experiment.", width=600)
error.place(x = 30, y = 10)
error.config(padx=0)

error = Message(text="First a set of images will be flashed. Just observe, no need to remember them.", width=600)
error.place(x = 30, y = 80)
error.config(padx=0)

error = Message(text="Next, the runs will be begin. For each run we will sum up 1000 random numbers. You will be instructed to do one of the following:", width=600)
error.place(x = 30, y = 120)
error.config(padx=0)

error = Message(text="1. Influence the sum to be positive", width=600)
error.place(x = 30, y = 160)
error.config(padx=0)

error = Message(text="2. Influence the sum to be negative", width=600)
error.place(x = 30, y = 180)
error.config(padx=0)
...
error = Message(text="After each run a sound will play indicating whether you were successful.", width=600)
...
name = Entry(text = "")
name.place(x=350, y=340, width=200, height=25)

label1 = Label(text = "Number of minutes for each run (1 default):")
label1.place(x = 30, y = 380)
label1.config(bg='lightgreen', padx=0)

duration = Entry(text = "")
duration.place(x=350, y=380, width=200, height=25)

label2 = Label(text = "Number of runs (10 default):")
label2.place(x = 30, y = 420)
label2.config(bg='lightgreen', padx=0)

runs = Entry(text = "")
runs.place(x=350, y=420, width=200, height=25)

button = Button(text = "Begin", command = start_trial)
button.place(x=350, y=460, width=75, height=35)
