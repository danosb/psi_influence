...
# optimizes main.py by reducing number of API calls and using psuedo-random numbers where possible
...
def start_trial():
    ...
    if  int(setDuration) > 0 and int(setDuration) < 11 and int(setRuncount) > 0 and int(setRuncount) < 6001:
